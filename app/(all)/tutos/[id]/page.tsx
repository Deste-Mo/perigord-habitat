    ...
    return (
      <div className="min-h-screen bg-muted flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center p-8">
          <div className="text-center bg-card rounded-3xl shadow-2xl p-12 max-w-md border border-border">
            <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-indigo-100 dark:bg-indigo-950/30 flex items-center justify-center">
    ...
    <div className="min-h-screen bg-muted flex flex-col">
      ...
      <main className="flex-1 w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-wrap items-center gap-4 mb-8">
          <button
            onClick={() => router.back()}
            className="inline-flex items-center gap-2 px-5 py-3 bg-card text-foreground rounded-xl hover:bg-indigo-600 hover:text-white transition-all shadow-md hover:shadow-xl group border border-border hover:border-indigo-600 font-medium"
          >
