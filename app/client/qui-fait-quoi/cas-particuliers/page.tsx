      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-4 py-8">
        ...
        <div className="bg-card rounded-xl border border-border shadow-sm p-6 sm:p-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-12 rounded-xl bg-purple-50 dark:bg-purple-950/20 text-purple-600 dark:text-purple-400 flex items-center justify-center">
              <AlertCircle size={24} />
            </div>
            <h1 className="text-2xl font-bold text-foreground">Cas particuliers</h1>
          </div>
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-lg font-bold text-foreground">Cas 1 — Le dégât des eaux</h2>
            </div>
            
            <p className="text-foreground text-sm mb-4">Qui fait quoi dépend de l&apos;origine :</p>
            
            <div className="overflow-x-auto mb-4">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-blue-600 dark:bg-blue-700 text-white">
                    <th className="text-left p-3 text-sm font-semibold border border-blue-700">Origine de la fuite</th>
                    <th className="text-left p-3 text-sm font-semibold border border-blue-700">Responsable</th>
                  </tr>
                </thead>
                <tbody>
                  {degatEauxData.map((item, idx) => (
                    <tr key={idx} className={idx % 2 === 0 ? "bg-blue-50 dark:bg-blue-950/20" : "bg-card"}>
                      <td className="p-3 text-sm text-foreground border border-border">{item.origine}</td>
                      <td className={`p-3 text-sm font-semibold border border-border ${
                        item.color === 'blue' ? 'text-blue-600 dark:text-blue-400' : 
                        item.color === 'orange' ? 'text-orange-600 dark:text-orange-400' : 'text-muted-foreground'
                      }`}>
                        {item.responsable}
                      </td>
                    </tr>
            ...
            <div className="bg-blue-50 dark:bg-blue-950/20 rounded-lg p-4 border-l-4 border-blue-500 dark:border-blue-400">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-lg font-bold text-foreground">Cas 2 — La vétusté (usure normale)</h2>
            </div>
            
            <div className="bg-orange-50 dark:bg-orange-950/20 rounded-lg p-4 border-l-4 border-orange-500 dark:border-orange-400">
              <p className="text-sm text-foreground leading-relaxed">
                ...
                (→ voir section <Link href="/client/qui-fait-quoi/vetuste" className="text-orange-600 dark:text-orange-400 font-semibold underline">Grille de vétusté</Link>)
              </p>
            </div>
          </div>
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-lg font-bold text-foreground">Cas 3 — La mauvaise utilisation</h2>
            </div>
            
            <div className="bg-red-50 dark:bg-red-950/20 rounded-lg p-4 border-l-4 border-red-500 dark:border-red-400 mb-4">
              ...
              <p className="text-sm font-semibold text-foreground mb-2">Exemples :</p>
              <ul className="space-y-1">
                {mauvaiseUtilisationExamples.map((example, idx) => (
                  <li key={idx} className="text-sm text-foreground">• {example}</li>
                ))}
              </ul>
            </div>
          </div>
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-lg font-bold text-foreground">Cas 4 — Le sinistre (incendie, inondation)</h2>
            </div>
            
            <div className="space-y-3">
              <div className="bg-muted rounded-lg p-4 border-l-4 border-gray-400 dark:border-gray-600">
                <p className="text-sm text-foreground leading-relaxed">
            ...
            <div className="bg-blue-50 dark:bg-blue-950/20 rounded-lg p-4 border-l-4 border-blue-500 dark:border-blue-400 mt-4">
              <p className="text-sm text-blue-800 dark:text-blue-300 leading-relaxed">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-lg font-bold text-foreground">Cas 5 — Les contrats spécifiques</h2>
            </div>
            
            <div className="bg-purple-50 dark:bg-purple-950/20 rounded-lg p-4 border-l-4 border-purple-500 dark:border-purple-400 mb-4">
              <p className="text-sm text-foreground leading-relaxed mb-3">
            ...
            <p className="text-sm font-semibold text-foreground mb-2">Exemples de contrats spécifiques fréquents :</p>
            <ul className="space-y-1">
              {contratsSpecifiques.map((contrat, idx) => (
                <li key={idx} className="text-sm text-foreground">• {contrat}</li>
              ))}
            </ul>
          </div>
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              <Wrench size={20} className="text-red-600 dark:text-red-400" />
              <h2 className="text-lg font-bold text-foreground">Cas 6 — Travaux d&apos;urgence</h2>
            </div>
            ...
            <div className="bg-amber-50 dark:bg-amber-950/20 border-l-4 border-amber-500 dark:border-amber-400 rounded-lg p-4">
