      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-4 py-8">
        ...
        <div className="bg-card rounded-xl border border-border shadow-sm p-6 sm:p-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-12 rounded-xl bg-orange-50 dark:bg-orange-950/20 text-orange-600 dark:text-orange-400 flex items-center justify-center">
              <Calendar size={24} />
            </div>
            <h1 className="text-2xl font-bold text-foreground">Grille de vétusté</h1>
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="bg-blue-50 dark:bg-blue-950/20 rounded-lg p-5 border-l-4 border-blue-500 dark:border-blue-400">
              ...
              <div className="bg-card rounded-lg p-4 mt-3">
                <p className="font-semibold text-foreground mb-2 text-sm">Exemple simple :</p>
          ...
          <div className="mb-8">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-orange-600 dark:bg-orange-700 text-white">
                    <th className="text-left p-3 text-sm font-semibold border border-orange-700">Élément</th>
                    <th className="text-left p-3 text-sm font-semibold border border-orange-700">Durée de vie</th>
                    <th className="text-left p-3 text-sm font-semibold border border-orange-700">Franchise locataire</th>
                  </tr>
                </thead>
                <tbody>
                  {vetusteData.map((item, idx) => (
                    <tr key={idx} className={idx % 2 === 0 ? "bg-orange-50 dark:bg-orange-950/20" : "bg-card"}>
                      <td className="p-3 text-sm text-foreground border border-border">{item.element}</td>
                      <td className="p-3 text-sm text-foreground border border-border font-semibold">{item.duree}</td>
                      <td className="p-3 text-sm text-foreground border border-border">{item.franchise}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <div className="mb-8">
            ...
            <div className="bg-green-50 dark:bg-green-950/20 rounded-lg p-5 border-l-4 border-green-500 dark:border-green-400">
              <p className="text-foreground text-sm leading-relaxed mb-3">
                La formule est simple :
              </p>
              <div className="bg-card rounded-lg p-4 mb-3">
                <p className="font-mono text-center text-base font-semibold text-foreground">
                  Votre part (%) = 100 % × (années restantes ÷ durée de vie totale)
                </p>
              </div>
              <div className="bg-card rounded-lg p-4">
                <p className="font-semibold text-foreground mb-2 text-sm">Exemple :</p>
                <p className="text-foreground text-sm leading-relaxed">
